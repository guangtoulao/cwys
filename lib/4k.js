var rule = {
  ...
  推荐: "body ul.stui-vodlist li;a&&title;.stui-vodlist__thumb&&data-original;pic-text&&Text;a&&href",
  一级: "body ul.stui-vodlist li;a&&title;.stui-vodlist__thumb&&data-original;pic-text&&Text;a&&href",
  搜索: "ul.stui-vodlist:eq(0) li,ul.stui-vodlist:eq(0) li,#searchList li;a&&title;.lazyload&&data-original;.text-muted&&Text;a&&href",
  // 二级：手填区覆盖了模板字段（已转 $js.toString 函数并去随机尾数）
  二级: $js.toString(() => {
  var HOST = "https://www.4kdyws.top";
  ...
  var tabsSel = ".stui-vodlist__head .nav-tabs a[data-toggle=\"tab\"]";
  ...
  for (var i=0;i<names.length;i++){
    var p1 = ".stui-content__playlist:eq(#id) li".replace(/#idv/g, names[i]).replace(/#id/g, String(i));
